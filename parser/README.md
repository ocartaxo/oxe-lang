...
```oxe
// Este é um arquivo de exemplo para testar o analisador léxico da linguagem "Oxe Lang"
...
var oxente saudacao = "Olá, mundo da Bahia!";
var oxente outraMensagem = "Bora pra cima!";
...
// Laço 'faz...enquanto' (equivalente ao do-while)
var inteiro j = 0;
faz {
